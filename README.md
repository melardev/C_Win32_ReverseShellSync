# Introduction
Reverse Shell written in C using Win32 API, the approach used is synchronous for both: Sockets and Process Pipes.<br/>
...
## WARNING
This is not the same code as other C Win32 Reverse shell I have on Github, that other, directly assigns the process
